...
function AboutScreen() {
  const about =
    "This app is created by TripSit, an organisation which helps to provide factual information about drugs and how to reduce the harms involved in using them. We also have an active IRC (internet relay chat) network where we provide tripsitting services, harm reduction advice, and general chat.";
  const disclaimer =
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={[styles.aboutHeaderText, styles.topSpacer]}>Disclaimer</Text>
        <Text style={styles.text}>{disclaimer}</Text>
        <Text style={[styles.aboutHeaderText, styles.topSpacer]}>Support TripSit</Text>
        <Text style={styles.text}>{support}</Text>
        <View style={[styles.row, styles.justifyCenter, styles.topSpacer]} contentD>
          <TouchableOpacity
            onPress={() => {
